...
///  }
///
class PhoenixDialog extends AlertDialog {
  /// 标题控件
  ...
  Widget build(BuildContext context) {
    DialogConfig? defaultConfig = themeData ?? DialogConfig();
            ...
            child: Material(
              shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.all(Radius.circular(
                      DialogUtils.getDialogRadius(defaultConfig)))),
              color: defaultConfig.backgroundColor,
              child: dialogChild,
            )));
  }

  Widget _generateIconWidget(BuildContext context, DialogConfig dialogConfig) {
  ...
  Widget _generateTitleWidget(BuildContext context, DialogConfig dialogConfig) {
    if (titleWidget != null) {
      return DefaultTextStyle(
        textAlign: dialogConfig.titleTextAlign,
        style: DialogUtils.getDialogTitleStyle(dialogConfig),
        child: titleWidget!,
      );
    }
  ...
  Widget _generateContentWidget(
      BuildContext context, DialogConfig dialogConfig) {
  ...
  Widget _generateMainWidget(Widget widget, Color background, _ButtonType type,
      int index, DialogConfig dialogConfig) {
    return Container(
          ...
          shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.only(
                  bottomLeft: Radius.circular(type == _ButtonType.single ||
                      ...
                      ? DialogUtils.getDialogRadius(dialogConfig)
                      : 0),
  ...
  Widget _generateActionsWidget(
      BuildContext context, DialogConfig defaultConfig) {
  ...
  Widget _mapTextToGesWidget(BuildContext context, String label, int index,
      bool main, DialogConfig dialogConfig,
  ...
  /// 主题配置的标题间距
  EdgeInsetsGeometry _configTitlePadding(DialogConfig dialogConfig) {
    return _isShowIcon()
  ...
  /// 主题配置的内容间距
  EdgeInsetsGeometry _configContentPadding(DialogConfig dialogConfig) {
  ...
  /// 主题配置的警告间距
  EdgeInsetsGeometry _configWarningPadding(DialogConfig dialogConfig) {
