...
import '../extension/dialog_default_config_utils.dart';
...
class DialogConfig extends BaseConfig {
  DialogConfig({
    ...
    BaseTextStyle? warningTextStyle,
    TextAlign? warningTextAlign,
    EdgeInsets? dividerPadding,
    BaseTextStyle? mainActionTextStyle,
    BaseTextStyle? assistActionsTextStyle,
  ...
  double get dialogWidth =>
      _dialogWidth ?? BaseDialogConfigUtils.defaultDialogConfig.dialogWidth;
  ...
  EdgeInsets get iconPadding =>
      _iconPadding ?? BaseDialogConfigUtils.defaultDialogConfig.iconPadding;
  ...
  EdgeInsets get titlePaddingSm =>
      _titlePaddingSm ??
      BaseDialogConfigUtils.defaultDialogConfig.titlePaddingSm;
  ...
  EdgeInsets get titlePaddingLg =>
      _titlePaddingLg ??
      BaseDialogConfigUtils.defaultDialogConfig.titlePaddingLg;
  ...
  BaseTextStyle get titleTextStyle =>
      _titleTextStyle ??
      BaseDialogConfigUtils.defaultDialogConfig.titleTextStyle;
  ...
  TextAlign get titleTextAlign =>
      _titleTextAlign ??
      BaseDialogConfigUtils.defaultDialogConfig.titleTextAlign;
  ...
  EdgeInsets get contentPaddingSm =>
      _contentPaddingSm ??
      BaseDialogConfigUtils.defaultDialogConfig.contentPaddingSm;
  ...
  EdgeInsets get contentPaddingLg =>
      _contentPaddingLg ??
      BaseDialogConfigUtils.defaultDialogConfig.contentPaddingLg;
  ...
  TextAlign get contentTextAlign =>
      _contentTextAlign ??
      BaseDialogConfigUtils.defaultDialogConfig.contentTextAlign;
  ...
  EdgeInsets get warningPaddingSm =>
      _warningPaddingSm ??
      BaseDialogConfigUtils.defaultDialogConfig.warningPaddingSm;
  ...
  EdgeInsets get warningPaddingLg =>
      _warningPaddingLg ??
      BaseDialogConfigUtils.defaultDialogConfig.warningPaddingLg;
  ...
  ///   fontSize: [BrnCommonConfig.fontSizeBase],
  /// )
  BaseTextStyle? _warningTextStyle;

  BaseTextStyle get warningTextStyle =>
      _warningTextStyle ??
      BaseDialogConfigUtils.defaultDialogConfig.warningTextStyle;
  ...
  TextAlign get warningTextAlign =>
      _warningTextAlign ??
      BaseDialogConfigUtils.defaultDialogConfig.warningTextAlign;
  ...
  EdgeInsets get dividerPadding =>
      _dividerPadding ??
      BaseDialogConfigUtils.defaultDialogConfig.dividerPadding;
  ...
  ///   fontWeight: FontWeight.w600,
  /// )
  BaseTextStyle? _mainActionTextStyle;

  BaseTextStyle get mainActionTextStyle =>
      _mainActionTextStyle ??
      BaseDialogConfigUtils.defaultDialogConfig.mainActionTextStyle;
  ...
  ///   fontWeight: FontWeight.w600,
  /// )
  BaseTextStyle? _assistActionsTextStyle;
  ...
  Color get assistActionsBackgroundColor =>
      ...
      BaseDialogConfigUtils.defaultDialogConfig.assistActionsBackgroundColor;
